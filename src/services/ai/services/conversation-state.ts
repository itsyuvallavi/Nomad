...
import type { GeneratePersonalizedItineraryOutput, Itinerary } from '@/services/ai/schemas';
import type { InputType, ClassificationResult } from '@/services/ai/utils/input-classifier';
