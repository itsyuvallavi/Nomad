...
const AppleIcon = () => (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 16 16">
        <path d="M8.28,1.5c-1.14,0-2.2.5-2.93.95-.79.54-1.53.94-2.2.94-.65,0-1.28-.35-1.9-.9-.45-.4-.95-.7-1.48-.82-.17-.04-.34-.06-.52-.06-.31,0-.61.08-.88.24a2.2,2.2,0,0,0-1.07,1.91c0,1.4.79,2.85,2.1,3.89.69.55,1.52,1,2.4,1.05.85,0,1.7-.42,2.46-.9.6-.38,1.23-.74,1.9-.74s1.3.36,1.9.74c.76.48,1.6.9,2.45.9.88,0,1.7-.5,2.4-1.05,1.3-1,2.1-2.5,2.1-3.9,0-1.1-.53-2.07-1.35-2.53a2.41,2.41,0,0,0-2.43.3c-.56.43-1.16.8-1.8.8-.68,0-1.32-.42-2.13-.97A4.2,4.2,0,0,0,8.28,1.5Z"/>
        <path d="M6.1,10.61c-.9.9-2.3.9-3.2,0a.66.66,0,0,1,0-.94.66.66,0,0,1,.94,0c.5.5,1.3.5,1.8,0a.66.66,0,0,1,.94,0,.66.66,0,0,1,0,.94Zm4.75-2.17a.66.66,0,0,1-.94,0c-.5-.5-1.3-.5-1.8,0a.66.66,0,0,1-.94,0,.66.66,0,0,1,0-.94c.9-.9,2.3-.9,3.2,0a.66.66,0,0,1,0,.94Z"/>
    </svg>
);
