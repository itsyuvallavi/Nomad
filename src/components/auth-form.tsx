...
// Corrected SVG Icon for Apple
const AppleIcon = () => (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M19.35,14.16a2.8,2.8,0,0,1-1.24,2.06,2.94,2.94,0,0,1-1.93.63,2.87,2.87,0,0,1-1.87-.6,2.72,2.72,0,0,1-1.23-2.09,2.83,2.83,0,0,1,.83-2.22,2.69,2.69,0,0,1,2.15-1,2.6,2.6,0,0,1,1.86.58,2.63,2.63,0,0,1,1.21,2.07M15,5.63a3.28,3.28,0,0,0,1.38-2.23,3.34,3.34,0,0,0-2-3.2,3.28,3.28,0,0,0-3.33,2,3.31,3.31,0,0,0,2,3.22,3.29,3.29,0,0,0,2,.21M12.1,24A7.44,7.44,0,0,1,7.49,20.3a7,7,0,0,1,1.93-5.2,7.1,7.1,0,0,1,5.32-2.15,7.31,7.31,0,0,1,4,1.05,6.53,6.53,0,0,1,1,.73,7.6,7.6,0,0,0-5.11,6.23,7.18,7.18,0,0,0,2.54,6.21A7.27,7.27,0,0,1,12.1,24"></path>
    </svg>
);
