...
export default function ChatDisplay({
    ...
    // Renders the correct content for the desktop itinerary panel
    const renderDesktopItineraryPanel = () => {
        if (currentItinerary) {
            return (
                <ItineraryPanel 
        ...
        if (isGenerating) {
            return <ModernLoadingPanel progress={generationProgress} />;
        }
