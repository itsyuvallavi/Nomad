...
export function EventCard({ title, time, description, address, category, index }: EventCardProps) {
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className={`w-10 h-10 bg-gradient-to-br ${categoryColors[category]} rounded-lg flex items-center justify-center text-white text-lg flex-shrink-0`}>
